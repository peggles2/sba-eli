...
describe('SearchPage', () => {
  it("should render meta tags with Search specific information", () => {
    const wrapper = shallow(<SearchPage location={{search: ''}} dispatch={()=>{}} />);
  ...
  it('should render a <Header> that displays the search term', () => {
    ...
    const wrapper = shallow(<SearchPage location={urlString} dispatch={()=>{}} searchMetadata={searchMetadata} />);
  ...
  it('should render a <Header> that displays text for a single search result', () => {
    ...
    const wrapper = shallow(<SearchPage location={{search: "?searchTerm=" + searchTerm}} dispatch={()=>{}} searchMetadata={searchMetadata} />);
  ...
  it('should display blank, without an error, if no search term is available', () => {
    ...
    const wrapper = shallow(<SearchPage location={urlString} dispatch={()=>{}}/>);
  ...
  it('should render a <Pagination> component if there is more than 1 page of results', () => {
    ...
    const wrapper = shallow(<SearchPage location={{search: ''}} dispatch={()=>{}} searchMetadata={searchMetadata} />);
